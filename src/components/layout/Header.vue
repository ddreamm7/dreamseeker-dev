...
<template>
  <header
    class="border-b-default bg-primary fixed inset-x-0 top-0 z-50 flex h-16 items-center justify-between border-b-2 px-8 sm:px-16 md:px-24 lg:px-32 xl:px-40 2xl:px-48"
  >
    <a href="/">
      <img
        src="@/assets/images/branding/dreamspace-favicon.webp"
        alt="dreamspace_logo"
        class="h-6 w-auto object-contain"
      />
    </a>
    <nav v-if="isDesktop" class="flex w-md gap-x-4 lg:gap-x-8">
